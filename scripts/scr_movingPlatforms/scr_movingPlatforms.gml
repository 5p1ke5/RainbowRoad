...
function moving_platform_step()
{
	...
	//var _collisions = collision_rectangle_array(bbox_left, bbox_top - - 1, bbox_right, bbox_top, all, true, true, false);
	var _collisions = collision_rectangle_array(bbox_left, bbox_top - vsp - 6, bbox_right, bbox_top, all, true, true, false);
