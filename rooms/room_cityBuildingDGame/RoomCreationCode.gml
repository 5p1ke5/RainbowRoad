...
{
	var _doorX = _startX + (_i * _marginX);
	var _door = instance_create_layer(_doorX, _floor4Y, "Level", obj_hotelDoorOpen)
	array_push(_floor4, _door);
}


// Generates elevators.
//Gets a random door from each floor
var _floor1ElevatorUpIndex = irandom(array_length(_floor1))
var _floor1ElevatorUpDoor = _floor1[_floor1ElevatorUpIndex];

var _floor2ElevatorDownIndex = irandom(array_length(_floor2))
